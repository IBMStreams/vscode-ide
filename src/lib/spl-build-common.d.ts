...
export class SplBuilder {
    ...
    constructor(filePath: string, messageHandler: MessageHandler, lintHandler: LintHandler, openUrlHandler: Function, originator?: { originator: string, version: string, type: string });
